export default {
	...
	workspaceMembers: {
		title: 'Участники рабочей области',
		...
		modal: {
			invite: {
				...
				roleLabel: 'Роль',
				roleEditor: 'Редактор - Может редактировать контент',
				roleViewer: 'Наблюдатель - Может только просматривать',
				roleEditorDesc: 'Редакторы могут создавать, редактировать и удалять контент.',
				roleViewerDesc: 'Наблюдатели могут только просматривать контент, но не редактировать.',
				cancel: 'Отмена',
			...
			success: {
				...
				description: 'Поделитесь этой ссылкой с пользователем:',
				copy: 'Копировать',
				copied: 'Скопировано!',
				expiresIn: 'Ссылка истекает через 7 дней',
				done: 'Готово'
			}
		},
		alerts: {
			removeConfirm: 'Вы уверены, что хотите удалить этого участника?'
		}
	}
};
